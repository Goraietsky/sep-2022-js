...
//
//     let divsimponss=document.createElement('div')
//     divsimponss.innerText = `${name} ${surname} ${age} ${info}`;
//
//     let img = document.createElement('img');
//     img.src = photo;
//
//     div.append(divsimponss,img)
...
// -----------
//
//     - Створити довільний елемент з id = text.  Використовуючи JavaScript, зробіть так, щоб при натисканні на кнопку зникав
//     елемент з id="text".
...
button.onclick = () => {
    ...
    const generateTable = (raws,colums,word)=>{
